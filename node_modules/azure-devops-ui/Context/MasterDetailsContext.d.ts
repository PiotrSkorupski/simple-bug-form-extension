...
export declare class BaseMasterDetailsContext implements IMasterDetailsContext {
    ...
    push: (newLayer: IMasterDetailsContextLayer<any, any>) => void;
 ...
 */
export declare function createChildLayer<T, P>(key: string, masterPanelDetails: IMasterPanelContent<T, P>, detailsContent: IDetailsAreaContent<T>, initialSelectedItem: T, parentLayer: IMasterDetailsContextLayer<P, any>, onPushed?: (context: IMasterDetailsContext) => void): IMasterDetailsContextLayer<T, P>;
