 ...
 */
export declare const enum TableColumnLayout {
    /**
 ...
 */
export declare const enum TableColumnStyle {
    /**
...
export interface IColumnSortProps {
    /**
     * When the sort order is ascending, the ariaLabelAscending is applied to the icon.
     */
    ariaLabelAscending?: string;
    /**
     * When the sort order is descending, the ariaLabelDescending is applied to the icon.
     */
...
/**
 * ITableColumn is used to commnuicate details about the column, its layout
...
export interface ITableColumn<T> {
     ...
     */
    renderCell: (rowIndex: number, columnIndex: number, tableColumn: ITableColumn<T>, tableItem: T) => JSX.Element;
    /**
     ...
     */
    renderHeaderCell?: (columnIndex: number, tableColumn: ITableColumn<T>, focuszoneId: string | undefined) => JSX.Element;
    /**
     ...
     *
     * @param event - This is the mouse event that has caused the resize to occur.
     ...
     */
    onSize?: (event: MouseEvent, columnIndex: number, width: number, column: ITableColumn<T>) => void;
    /**
