...
var VssPersona = /** @class */ (function (_super) {
    ...
    VssPersona.prototype.render = function () {
        var _a = this.props, identityDetailsProvider = _a.identityDetailsProvider, _b = _a.size, size = _b === void 0 ? "medium" : _b, _c = _a.imgAltText, imgAltText = _c === void 0 ? "" : _c, imageUrl = _a.imageUrl, displayName = _a.displayName;
        ...
        // Setting the aria related properties and user action delegates only if suppressPersonaCard is false
        ...
        return (React.createElement(Tooltip, { text: displayName, showOnFocus: true },
            React.createElement("div", tslib_1.__assign({ className: css("vss-Persona flex-noshrink", this.props.className, this.props.cssClass, size), ref: this.setTargetElement }, additionalAttributes),
                imageElement,
