...
import { IReadonlyObservableValue, IReadonlyObservableArray } from '../../Core/Observable';
...
export interface ITabProps extends ISharedTabProps {
    ...
    ariaLabel?: string;
    /**
     * Number to display next to the name of the tab in a badge
     */
