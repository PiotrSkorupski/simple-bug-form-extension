...
var PillGroup = /** @class */ (function (_super) {
    tslib_1.__extends(PillGroup, _super);
    function PillGroup(props) {
        ...
        _this.state = { overflowing: false };
        return _this;
    }
    PillGroup.prototype.render = function () {
        var _this = this;
        var _a = this.props, onMouseEnter = _a.onMouseEnter, onMouseLeave = _a.onMouseLeave, overflow = _a.overflow;
        var contents;
        ...
        if (overflow === 2 /* fade */) {
            contents = (React.createElement(IntersectionContext.Consumer, null, function (intersectionContext) {
                ...
                return (React.createElement("div", { className: "bolt-pill-overflow flex-row" },
                    React.createElement("div", { className: "bolt-pill-group-inner flex-row" }, _this.props.children),
                    React.createElement("div", { className: "bolt-pill-observe", ref: function (element) { return _this.observeElement(element); } })));
            }));
        }
        else {
            contents = React.createElement("div", { className: "bolt-pill-group-inner flex-row" }, this.props.children);
        }
        // Wrap the pill group in the outer shell.
        contents = (React.createElement("div", { className: css(this.props.className, "bolt-pill-group flex-row", overflow === 1 /* wrap */
                ? "overflow-wrap"
                : overflow === 2 /* fade */
