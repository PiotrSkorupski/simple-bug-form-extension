...
var EditableLabelGroup = /** @class */ (function (_super) {
    tslib_1.__extends(EditableLabelGroup, _super);
    function EditableLabelGroup(props) {
        ...
        _this.onLabelKeyDown = function (event, model, index) {
            ...
            var selectedOrFocusedContents = new Set(_this.selectedLabelContents.value.concat([model.content]));
            if (event.which === 8 /* backspace */ || event.which === 46 /* delete */) {
            ...
            else if (event.which === 38 /* upArrow */ ||
                event.which === 40 /* downArrow */ ||
                event.which === 37 /* leftArrow */ ||
                event.which === 39 /* rightArrow */) {
                _this.selectedLabelContents.removeAll();
            }
        };
    ...
    EditableLabelGroup.prototype.render = function () {
        ...
        var actualWrappingBehavior = isInEditMode ? 0 /* freeFlow */ : this.props.wrappingBehavior;
        var bodyContent;
        ...
        return (React.createElement("div", { className: css(className, "bolt-labelgroup-editable flex-column", editClassName), onFocus: this.onFocus, onBlur: this.onBlur, onMouseDown: this.onOuterMouseDown, onMouseEnter: function () { return (_this.renderTitleIconFlag.value = isInEditMode ? false : true); }, onMouseLeave: function () { return (_this.renderTitleIconFlag.value = false); } },
            title && (React.createElement(Observer, { renderIconFlag: this.renderTitleIconFlag }, function (observerProps) { return (React.createElement("div", { className: "bolt-labelgroup-title-wrapper font-size-m flex-row" },
