...
export var DefaultAbridgedCard = function (props) {
    ...
    return (React.createElement("div", { className: "default-card-abridged flex-row" },
        React.createElement("div", { className: "flex-row" },
            React.createElement(Persona, { className: "persona-main", size: 8 /* extraLarge */, identity: props.identity }),
            React.createElement("div", { className: "flex-column flex-grow bolt-identity-card-name" },
                React.createElement("div", { className: "bolt-identity-card-persona-main-text-primary " }, displayName))),
        verifySignInAddress(signInAddress) && (React.createElement("div", null,
