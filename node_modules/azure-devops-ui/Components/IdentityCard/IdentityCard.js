...
var IdentityCard = /** @class */ (function (_super) {
    tslib_1.__extends(IdentityCard, _super);
    function IdentityCard(props) {
        ...
        _this.onShowContactCard = function () {
            var newDataState = tslib_1.__assign({}, _this.state.dataState, { previousDataState: _this.state.dataState, cardType: 1 /* Contact */, header: _this.state.dataState.identity });
            _this.setState({
        ...
        _this.onShowOrganizationCard = function () {
            ...
            if (currentDataState.isGroup) {
                ...
                var newDataState = tslib_1.__assign({}, currentDataState_1, { cardType: 2 /* Organization */, header: currentDataState_1.identity, previousDataState: currentDataState_1 });
                _this.setState({
                    dataState: newDataState
                });
                ...
                var newDataState = tslib_1.__assign({}, currentDataState_2, { cardType: 2 /* Organization */, header: currentDataState_2.identity, previousDataState: currentDataState_2 });
                _this.setState({
                    dataState: newDataState,
                    working: true
                });
                ...
                var newDataState = tslib_1.__assign({}, currentDataState_3, { cardType: 2 /* Organization */, header: currentDataState_3.identity, previousDataState: currentDataState_3 });
                _this.setState({
                    dataState: newDataState,
                    working: false
                });
        ...
        _this.updateConnections = function (dataState, connections) {
            ...
            if (_this.state.dataState && dataState.identity === _this.state.dataState.identity) {
                _this.setState({
                    dataState: tslib_1.__assign({}, _this.state.dataState, { managerList: connections.managers && connections.managers.reverse(), directReportList: connections.directReports, successors: connections.successors }),
                    working: false
                });
            }
        };
        _this.updateEntity = function (identity) {
            var hasCompleteIdentity = Utils.isCompleteIdentity(identity, true);
            var requireConnections = (Utils.isGroup(identity) && (!_this.state.dataState.successors || _this.state.dataState.successors.length <= 0)) ||
                (Utils.isAadUser(identity) || Utils.isAdUser(identity));
            ...
            var newDataState = tslib_1.__assign({}, _this.state.dataState, { identity: identity, displayName: identity.displayName, imageUrl: imageUrl, isGroup: Utils.isGroup(identity) });
    ...
    IdentityCard.prototype.render = function () {
        return this.props.uniqueAttribute || this.props.identity || this.props.displayName ? (React.createElement(IdentityCardContent, tslib_1.__assign({}, this.props, { dataProps: this.state.dataState, onClickEntity: this.onClickEntity, onDismissCallback: this.onDismissCallback, onShowContactCard: this.onShowContactCard, onShowOrganizationCard: this.onShowOrganizationCard, working: this.state.working, onHeaderClick: this.headerOnClickHandler }))) : (React.createElement("div", null));
    };
