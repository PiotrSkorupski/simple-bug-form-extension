...
.bolt-identity-card-go-back-wrapper {
...
.bolt-identity-card-persona-list-element {
  font-weight: inherit; }

.bolt-identity-card-loading-spinner {
  position: absolute;
  top: 40%;
  left: 40%; }
...
.bolt-identity-default-card-member-list-wrapper {
  padding-top: 4px; }
