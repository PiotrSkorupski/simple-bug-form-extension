...
export var GitHubCard = function (props) {
    ...
    return (React.createElement("div", { className: "bolt-identity-default-card-without-header" },
        React.createElement("div", { className: "flex-row" },
            React.createElement(Persona, { className: "bolt-identity-card-persona-main", size: 9 /* extraExtraLarge */, identity: identity }),
            React.createElement("div", { className: "flex-column flex-grow bolt-identity-card-name" },
                ...
                mailNickname === "" ? undefined : React.createElement("div", { className: "bolt-identity-card-persona-main-text-secondary" }, mailNickname),
                mail === "" ? undefined : React.createElement("div", { className: "bolt-identity-card-persona-main-text-tertiary" }, mail))),
