...
var Breadcrumb = /** @class */ (function (_super) {
    ...
    function Breadcrumb(props) {
        ...
        _this.renderBreadcrumbItems = function () {
            ...
            var itemElements = displayedItems.map(function (item, index) { return (React.createElement("div", { className: "bolt-breadcrumb-list-item", key: item.key || String(index) },
                ...
                index !== lastItemIndex && _this.getDivider(item.key))); });
            itemElements.splice(0, 0, React.createElement("div", { className: css("bolt-breadcrumb-overflow", hiddenItemCount > 0 && "bolt-breadcrumb-overflow-visible"), key: "overflowItem" },
                ...
                hiddenItemCount > 0 && hiddenItemCount < displayedItems.length && _this.getDivider("overflow")));
            if (extraContent) {
                itemElements.push(React.createElement("div", { key: "breadcrumb-extra-content", id: getSafeId("breadcrumb-extra-content") }, extraContent));
            }
        ...
        _this.renderItem = function (item) {
            var internalItem = (React.createElement(Tooltip, { text: item.text, overflowOnly: true },
                React.createElement("span", { className: "bolt-breadcrumb-item-text" }, item.text)));
        ...
        _this.getDivider = function (key) {
            return (React.createElement("div", { key: "BreadcrumbItemDivider$" + key, className: "bolt-breadcrumb-divider" },
                React.createElement("div", { className: "bolt-breadcrumb-forward-slash" }, "/")));
        };
    ...
    Breadcrumb.getDerivedStateFromProps = function (props, state) {
        ...
        return tslib_1.__assign({}, state, { displayedItems: displayedItems, linkItems: getLinkItems(displayedItems) });
    };
    Breadcrumb.prototype.render = function () {
        ...
        var overflowMenuItems = items.map(function (item, index) {
            return ({
                ...
                key: item.key,
                id: item.key,
                onActivate: _this.onMenuItemActivate,
                href: item.href
            });
        });
        var responsiveChildren = items.map(function (items, index) { return index + 1; });
