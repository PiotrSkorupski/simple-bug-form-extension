...
export declare const enum ContentJustification {
    Start = 0,
    Center = 1,
    End = 2,
    Stretch = 3
}
export declare const enum ContentLocation {
    Start = 0,
    Center = 1,
    End = 2
}
export declare const enum ContentOrientation {
    Column = 0,
    Row = 1
}
export declare const enum ContentSize {
    Small = 0,
    Medium = 1,
    Large = 2
}
