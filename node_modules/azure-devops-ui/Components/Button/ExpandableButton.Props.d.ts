...
import { IExpandableSharedProps } from '../../Expandable';
export interface IExpandableButton {
    collapse(): void;
    expand(): void;
}
export interface IExpandableButtonProps extends IExpandableSharedProps, IButtonProps {
     ...
     */
    renderCallout: (dropdown: IExpandableButton, dropdownId: string, anchorElement?: HTMLElement, anchorOffset?: IOffset, anchorOrigin?: IOrigin, anchorPoint?: IPoint, dropdownOrigin?: IOrigin) => JSX.Element;
}
