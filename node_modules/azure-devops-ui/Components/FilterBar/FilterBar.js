...
import { FILTER_CHANGE_EVENT, FILTER_APPLIED_EVENT } from '../../Utilities/Filter';
...
var FilterBar = /** @class */ (function (_super) {
    ...
    function FilterBar(props) {
        ...
        _this._calculateFiltersToShowStopIndex = function () {
            ...
            // Include the keyword filter in the size caluclation, but not the stop
            // index since it is pulled out of the array being sliced and rendered separately.
            var adjustForKeywordFilter = _this._firstChildIsKeywordItem ? 1 : 0;
            for (var i = 0; i < _this._childrenContainerElements.length; i++) {
                ...
                if (totalWidth > _this._filterBarElement.clientWidth) {
                    ...
                    var endIndex = _this.state.filtersToShowStartIndex + (i - adjustForKeywordFilter);
                    return endIndex > _this.state.filtersToShowStartIndex ? endIndex : _this.state.filtersToShowStartIndex + 1;
                }
            }
            return _this.state.filtersToShowStartIndex + _this._childrenContainerElements.length - adjustForKeywordFilter;
        };
    ...
    FilterBar.prototype.componentDidUpdate = function () {
        ...
        if (this.state.filtersToShowStopIndex < 0) {
            ...
            var adjustForKeywordFilter = this._firstChildIsKeywordItem ? 1 : 0;
            var allFiltersFit = filtersToShowStopIndex === React.Children.toArray(this.props.children).length - adjustForKeywordFilter;
            if (!allFiltersFit && !this.state.shouldHidePlaceholderLabels) {
                ...
                if (this._hasPagedRight &&
                    filtersToShowStopIndex === this.state.filtersToShowStartIndex + this._childrenContainerElements.length - adjustForKeywordFilter) {
    ...
    FilterBar.prototype.render = function () {
        ...
        var childrenWithProps = React.Children.map(children, function (child) {
            ...
            if (isFirstChild && childElement.props.isTextItem) {
                _this._firstChildIsKeywordItem = true;
            ...
            var childWithProps = React.cloneElement(childElement, {
                ...
                showPlaceholderAsLabel: !shouldHidePlaceholderLabels
            });
        ...
        var keywordItem;
        if (this._firstChildIsKeywordItem) {
            keywordItem = childrenWithProps.shift();
        }
        ...
        return (React.createElement(SurfaceContext.Consumer, null, function (surfaceContext) { return (React.createElement("div", { className: css(className, "vss-FilterBar", surfaceContext.background === 1 /* neutral */ && "bolt-filterbar-white depth-8 no-v-margin") },
            React.createElement("div", { className: css("vss-FilterBar--list", !keywordItem && "justify-right"), ref: function (elem) {
                ...
                React.createElement("div", { className: "vss-FilterBar--right-items", ref: function (elem) {
                    ...
                    (canPageLeft || canPageRight) && (React.createElement("div", { className: "vss-FilterBar--page-button-container" },
                        React.createElement(Button, { className: "filter-bar-button  vss-FilterBar-page-button", ref: function (elem) {
                            ...
                            }, onClick: _this._onPageLeft, disabled: !canPageLeft, ariaLabel: Resources.FilterPageLeftAriaLabel, iconProps: { iconName: "ChevronLeft" } }),
                        React.createElement(Button, { className: "filter-bar-button vss-FilterBar-page-button", ref: function (elem) {
                                _this._nextButtonElem = elem;
                            }, onClick: _this._onPageRight, disabled: !canPageRight, ariaLabel: Resources.FilterPageRightAriaLabel, iconProps: { iconName: "ChevronRight" } }))),
