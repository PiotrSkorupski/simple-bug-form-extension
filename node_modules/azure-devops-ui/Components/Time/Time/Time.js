...
var Time = /** @class */ (function (_super) {
    ...
    Time.prototype.render = function () {
        var props = {
            className: css(this.props.className, "bolt-time-item")
        };
        var TagName = "span";
        ...
        var content = React.createElement(TagName, tslib_1.__assign({}, props), this.state.output);
        if (this.props.tooltipProps) {
            content = React.createElement(Tooltip, tslib_1.__assign({}, this.props.tooltipProps), content);
        }
        return content;
    };
