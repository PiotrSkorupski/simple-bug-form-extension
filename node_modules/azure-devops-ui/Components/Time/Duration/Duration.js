...
var Duration = /** @class */ (function (_super) {
    ...
    Duration.prototype.render = function () {
        return (React.createElement(Time, { className: this.props.className, getNextInterval: this.getNextInterval, getTimeString: this.getTimeString, tooltipProps: this.state.tooltipProps }));
    };
    /**
     * Returns time in milliseconds for next refresh.
     *
