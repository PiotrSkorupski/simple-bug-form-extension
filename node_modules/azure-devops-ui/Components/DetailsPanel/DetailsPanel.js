...
export var DetailsPanel = function (props) {
    ...
    return (React.createElement(Surface, { background: 1 /* neutral */ },
        React.createElement("div", { className: css(props.className, "bolt-details-panel flex-row flex-grow") },
            React.createElement(Observer, { masterDetailsLayer: masterDetailsContext.getCurrentLayer() }, function (observableProps) { return (React.createElement(Observer, { selectedItem: observableProps.masterDetailsLayer.selectedMasterItem }, function (innerObservableProps) {
                return observableProps.masterDetailsLayer.detailsContent.renderContent(innerObservableProps.selectedItem);
            })); }))));
};
