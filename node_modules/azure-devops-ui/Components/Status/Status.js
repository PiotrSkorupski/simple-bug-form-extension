...
export function Status(props) {
    var animated = props.animated, ariaLabel = props.ariaLabel, className = props.className, color = props.color, onRenderIcon = props.onRenderIcon, text = props.text;
    var size = props.size === undefined ? "32" /* xl */ : props.size;
    if (text) {
        return (React.createElement("div", { "aria-label": text, className: css("bolt-status-extended flex-row flex-center", color, className, size === "32" /* xl */ && "xl") },
            onRenderIcon(css("bolt-status", color), size, animated),
            React.createElement("span", { className: css("bolt-status-text", size !== "24" /* l */ ? "font-size-mm xl" : "font-size", color === "neutral" && "bolt-status-text-extra-padding") }, text)));
    }
    else {
...
function Running(props) {
    var className = css(props.className, props.animated !== false ? (props.size === "12" /* s */ ? "small-animate" : "animate") : "");
    switch (props.size) {
        case "32" /* xl */:
        case "24" /* l */: {
