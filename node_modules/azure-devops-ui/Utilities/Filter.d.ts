...
import { IObservable, Observable, IObservableValue } from '../Core/Observable';
...
export declare class Filter implements IFilter {
    ...
    subscribe(observer: (value: IFilterState, action: string) => void, action?: string): void;
...
export declare const FilterContext: React.Context<{
    filter: IFilter;
    filterToggled: IObservableValue<boolean>;
}>;
