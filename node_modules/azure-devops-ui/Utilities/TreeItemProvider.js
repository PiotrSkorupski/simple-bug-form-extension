...
var TreeItemProvider = /** @class */ (function () {
    function TreeItemProvider(rootItems) {
        ...
        this.rootItems = rootItems.slice();
    ...
    TreeItemProvider.prototype.subscribe = function (observer, action) {
        this.tableItems.subscribe(observer, action);
    };
    ...
    TreeItemProvider.prototype.splice = function (parentItem, itemsToRemove, itemsToAdd) {
        ...
        if (itemsToAdd) {
            for (var index = 0; index < itemsToAdd.length; index++) {
                ...
                childItems.splice.apply(childItems, [childIndex, 0].concat(itemToAdd.items));
                ...
                if (tableItems) {
                    (_a = this.tableItems).splice.apply(_a, [insertIndex + 1, 0].concat(tableItems));
                    notifyChange = true;
                }
            }
        }
        ...
        if (itemIndex >= 0) {
            ...
            if (treeItem.childItems) {
                ...
                if (treeItem.expanded) {
                    (_a = this.tableItems).splice.apply(_a, [itemIndex + 1, 0].concat(tableItems));
                }
                else {
