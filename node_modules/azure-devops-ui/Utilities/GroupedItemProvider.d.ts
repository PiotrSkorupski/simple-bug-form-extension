...
export declare class GroupedItemProvider<T> implements IItemProvider<IListBoxItem<T>>, IObservable<IObservableArrayEventArgs<IListBoxItem<T>>, ObservableArrayAction> {
     ...
     */
    constructor(initialItems: IListBoxItem<T>[], initialGroups: IListBoxGroup[], manageHeaders?: boolean);
    /**
     * Get the internal array of groups.
     */
    readonly groups: IListBoxGroup[];
    /**
     ...
     */
    subscribe(observer: (value: IObservableArrayEventArgs<IListBoxItem<T>>, action?: ObservableArrayAction) => void, action?: ObservableArrayAction): void;
    /**
     ...
     * @param groups
     */
    pushGroups(...groups: IListBoxGroup[]): number;
    /**
     ...
     */
    spliceGroups(start: number, deleteCount: number, ...groupsToAdd: IListBoxGroup[]): IListBoxGroup[];
    /**
